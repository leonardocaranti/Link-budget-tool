...
min_dist_venus_earth = 0.27 #[AU]

def Venus_explorer():
    P = decibel(350, 1)                                                                   #Power in dBW
    ...
    h = min_dist_venus_earth*AU - h_venus
    ...
    V_g = sqrt(mu_venus / (Rvenus + h_venus)) * Re / (Rvenus + h_venus)                                           #Ground speed in m/s
